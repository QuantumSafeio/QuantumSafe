/*
  # Enhanced Points System and Social Media Integration

  1. New Tables
    - `points_transactions` - Detailed tracking of all point transactions
    - `social_media_stats` - Track social media engagement and posts
  ...
  2. Enhanced Existing Tables
    - Add social media points tracking to `user_points`
    - Add referral commission tracking to `referrals`
    - Add ambassador tier tracking
