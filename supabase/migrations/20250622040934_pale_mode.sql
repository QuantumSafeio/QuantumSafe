/*
  # Enhanced Points and Referral System Migration

  1. New Tables
    - `points_transactions` - Detailed tracking of all point transactions
    - `social_media_stats` - Social media engagement tracking per platform
    - `ambassador_tiers` - Ambassador program tier definitions
    - `user_achievements` - User achievement tracking

  2. Enhanced Existing Tables
    - Add detailed points breakdown columns to `user_points`
  ...
  4. Functions
    - `award_points` - Centralized point awarding with tracking
    - `calculate_ambassador_tier` - Automatic tier calculation
